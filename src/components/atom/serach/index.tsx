    ...
    <div className="w-full">
      ...
      {openMenu ? (
        filteredTasks.length > 0 ? (
              ...
              >
                <div className="w-full">
                  <MyIcon
                    ...
                    className="mr-1 flex items-center justify-between rounded-t-xl bg-gradient-to-r from-warning-500 via-warning-400 to-warning-500 p-1 text-title text-white"
                  />
          ...
          <div className="z-20 mt-1 rounded border-2 bg-white p-3 text-gray-500 shadow-sm">
            No results
          </div>
        )
      ) : null}
