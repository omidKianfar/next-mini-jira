    ...
    <FramerMotion>
      ...
      >
        <div className="flex flex-col items-center justify-center lg:flex-row lg:gap-12">
          <div className="mb-4 w-[90vw] rounded-lg border border-gray-300 bg-white p-6 pb-8 shadow-sm lg:mb-0 lg:w-[480px]">
            ...
            <h1 className="mb-6 text-center text-title font-bold text-primary-500 lg:text-h4">
              Profile
            </h1>
